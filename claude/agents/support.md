...
- Create detailed notes for every support case in ~/.claude/support/
...
# Output: found    /Users/arthur/.claude/support/2025-12-22/zendesk-40875
# Or:     new    /Users/arthur/.claude/support/2025-12-29/zendesk-40875
```
...
This agent creates **support notes** in `~/.claude/support/`. These are:

- Customer-specific investigations
- Time-bounded (organized by week)
- Used for weekly support log summaries

If during investigation you discover **reusable technical knowledge** that would benefit future development (not just this ticket), spawn the `note-taker` agent separately. That agent creates notes in `~/.claude/notes/{org}/{repo}/` for:
