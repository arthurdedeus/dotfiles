...
Never construct paths manually — the script derives org/repo from the current git repository, builds the path `~/.claude/notes/{org}/{repo}/{slug}.md`, and validates the slug format.
